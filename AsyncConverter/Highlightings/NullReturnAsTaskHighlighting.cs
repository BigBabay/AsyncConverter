...
{
    [RegisterConfigurableSeverity(SeverityId, null, AsyncConverterGroupSettings.Id, "Null return from async method", "May cause null reference exception if return of method will be awaiting.", Severity.WARNING)]
